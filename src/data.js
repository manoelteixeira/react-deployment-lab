const articleData = [
  {
    img: "./src/assets/c-d-x-unsplash.jpg",
    title: "The best headphones of this year",
    text: `Although earbuds are all the rage these days, true audiophiles know
  ...
  {
    img: "./src/assets/domenico-loia-unsplash.jpg",
    title: "The perfect work-from-home setup",
    text: `Is your work-from-home setup making you feel blue? If working from
  ...
  {
    img: "./src/assets/gilles-lambert-unsplash.jpg",
    title: "What exactly is the dark web?",
    text: `It seems like everyone has an opinion on the "dark web" these days.
  ...
  {
    img: "./src/assets/j-kelly-brito-unsplash.jpg",
    title: "Learning to code",
    text: `If you're just getting started on your coding journey, you may be
